...
void SPIPIC_set(char Enable, char IntEnable, char EdgeSampled, int DataMode, char Role, char FrqSCK){
    if (Enable == 0)
    {
        SSPCON &= ~(1<<0x5);
    }
